...
function Home() {
  ...
  useEffect(() => {
    AOS.init({duration: 500,easing: 'ease-in'});
  })
  ...
  return (
    <section className="min-h-screen flex flex-col items-center p-4">
      ...
      <div className="relative mb-8 w-full">
        <img data-aos="fade-right" data-aos-duration="400" className="backdrop-opacity-1 absolute w-[15rem] max-w-full top-2 left-[44%] transform -translate-x-1/2" src={logounder} alt="logo" />
